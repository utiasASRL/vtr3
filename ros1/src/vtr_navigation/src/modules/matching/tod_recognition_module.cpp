...
void TodRecognitionModule::run(QueryCache &qdata, MapCache &mdata,
  ...
  time_point time_of_day =
      asrl::common::timing::toChrono(live_vtx.keyFrameTime());
  ...
  // The algorithm
  status_msg_.set_algorithm(asrl::status_msgs::ExpRecogStatus_Algorithm_TIME);
...
ScoredRids scoreExperiences(const TodRecognitionModule::time_point &query_tp,
  ...
  for (const auto &it : submap) {
    ...
    TodRecognitionModule::time_point map_tp =
        asrl::common::timing::toChrono(v->keyFrameTime());
