...
public:
  ...
  typedef common::timing::time_point time_point;
...
private:
  ...
  status_msgs::ExpRecogStatus status_msg_;
};
...
scoreExperiences(
    ...
    const pose_graph::RCGraphBase & submap,             ///< The submap to process
    const TodRecognitionModule::Config & config);       ///< Configuration (for weights)
