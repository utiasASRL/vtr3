...
class ROSModuleFactory : public ROSBaseFactory<BaseModule> {
 public:
   ...
   */
  ROSModuleFactory(const NodePtr node, const std::string &param_prefix)
 ...
 private:
   ...
   * \param[in] new_module pointer to the module
   */
  void configureCVStereoSgbm(std::shared_ptr<BaseModule> &new_module) const;

  /** \brief configures the stereo disparity module using rosparam
   *
   * \param[in] new_module pointer to the module
   */
  void configureCVGpuStereoBM(std::shared_ptr<BaseModule> &new_module) const;
   ...
   * \param[in] new_module pointer to the module
   */
  void configureCVReprojector(std::shared_ptr<BaseModule> &new_module) const;
   ...
   * \param[in] new_module pointer to the module
   */
  void configureMonoTriangulator(std::shared_ptr<BaseModule> &new_module) const;
