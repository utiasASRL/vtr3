...
class MpcPath {
 public:
   ...
   * \details This is the same as Chris O's speed profiler but does not use experience to set a suggested speed.
   ...
   * \details Good direction switches have enough travel_backwards ahead of them and travel forwards behind them.
