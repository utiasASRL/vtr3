...
struct CameraQueryCache : public tactic::QueryCache {
  ...
  tactic::Cache<tactic::EdgeTransform> T_sensor_vehicle;
  ...
  tactic::Cache<tactic::EdgeTransform> T_r_m;
  tactic::Cache<tactic::EdgeTransform> T_r_m_prior;
  tactic::Cache<std::vector<vision::RigMatches>> raw_matches;
  tactic::Cache<std::map<tactic::VertexId, tactic::EdgeTransform>> T_sensor_vehicle_map;
  ...
  tactic::Cache<std::unordered_map<int, std::shared_ptr<steam::stereo::LandmarkNoiseEvaluator>>> stereo_landmark_noise;
