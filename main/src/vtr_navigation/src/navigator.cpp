...
if (pipeline->name() == "radar") {
  ...
  // gyro_bias_ << -0.0106098, -0.00742428, -0.00539962;     // 1118 utias10
  // gyro_bias_ << -0.00932944, -0.00916522, -0.00582339;    // 1120 yzd trial03
  gyro_bias_ << -0.00964617, -0.00923056, -0.00595137;     // 1201 utias_trial01
