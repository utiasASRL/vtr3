...
class OS : base::StaticClass {
 public:
  ...
  ///
  /// @details For android systems this is device name with its manufacturer and model separated by hyphen
...
class DateTime : base::StaticClass {
 public:
  ...
  ///
  /// @details For unix system it uses gettimeofday(timeval*, timezone*) and for Windows, a separate implementation is provided
...
class Configurations : public base::utils::RegistryWithPred<Configuration, Configuration::Predicate> {
 public:
  ...
  /// @param configurationsString todo
  /// @param base Configurations to base new configuration repository off. This value is used when you want to use
...
///
/// @details This class does not write logs itself instead its used by writer to read configurations from.
