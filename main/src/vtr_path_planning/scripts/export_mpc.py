...
shutil.move('unicycle_mpc_solver_follower.cpp', os.getenv("VTRSRC") + '/main/src/vtr_path_planning/src/mpc/unicycle_mpc_solver_follower.cpp')
shutil.move('unicycle_mpc_solver_follower.h', os.getenv("VTRSRC") + '/main/src/vtr_path_planning/include/vtr_path_planning/mpc/unicycle_mpc_solver_follower.hpp')