...
# CHANGES
#leader
lbx_l = ca.DM.zeros((n_states*(N+1) + n_controls*N, 1))
ubx_l = ca.DM.zeros((n_states*(N+1) + n_controls*N, 1))

lbx_l[0: n_states*(N+1): n_states] = -ca.inf     # X lower bound
lbx_l[1: n_states*(N+1): n_states] = -ca.inf     # Y lower bound
lbx_l[2: n_states*(N+1): n_states] = -ca.inf     # theta lower bound

ubx_l[0: n_states*(N+1): n_states] = ca.inf      # X upper bound
ubx_l[1: n_states*(N+1): n_states] = ca.inf      # Y upper bound
ubx_l[2: n_states*(N+1): n_states] = ca.inf      # theta upper bound

lbx_l[n_states*(N+1)::2] = v_min                  # v lower bound for all V
ubx_l[n_states*(N+1)::2] = v_max                  # v upper bound for all V
lbx_l[n_states*(N+1)+1::2] = w_min                # v upper bound for all V
ubx_l[n_states*(N+1)+1::2] = w_max                # v upper bound for all V
...
# follower
lbx_f = ca.DM.zeros((n_states*(N+1) + n_controls*N, 1))
ubx_f = ca.DM.zeros((n_states*(N+1) + n_controls*N, 1))

lbx_f[0: n_states*(N+1): n_states] = -ca.inf     # X lower bound
lbx_f[1: n_states*(N+1): n_states] = -ca.inf     # Y lower bound
lbx_f[2: n_states*(N+1): n_states] = -ca.inf     # theta lower bound

ubx_f[0: n_states*(N+1): n_states] = ca.inf      # X upper bound
ubx_f[1: n_states*(N+1): n_states] = ca.inf      # Y upper bound
ubx_f[2: n_states*(N+1): n_states] = ca.inf      # theta upper bound

lbx_f[n_states*(N+1)::2] = v_min                  # v lower bound for all V
ubx_f[n_states*(N+1)::2] = v_max                  # v upper bound for all V
lbx_f[n_states*(N+1)+1::2] = w_min                # v upper bound for all V
ubx_f[n_states*(N+1)+1::2] = w_max                # v upper bound for all V
...
#Corridor Width constraints
lbg_f[n_states*(N+1):n_states*(N+1)+N] = -500
ubg_f[n_states*(N+1):n_states*(N+1)+N] = 500
...
print("l ", lbg_l.shape, ubg_l.shape, lbx_l.shape, ubx_l.shape)
print("f ", lbg_f.shape, ubg_f.shape, lbx_f.shape, ubx_f.shape)
