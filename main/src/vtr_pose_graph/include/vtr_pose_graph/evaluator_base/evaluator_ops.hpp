...
class BinaryOp : public EvalBase<RVAL> {
 public:
  ...
  void setGraph(void *graph) override {
    eval1_->setGraph(graph);
    eval2_->setGraph(graph);
  }

  // clang-format off
  /** \brief Non-const accessor methods. \note doesn't return a reference */
  RVAL operator[](const SimpleEdge &e) override { return this->func_(this->eval1_->operator[](e), this->eval2_->operator[](e)); }
  RVAL operator[](const SimpleVertex &v) override { return this->func_(this->eval1_->operator[](v), this->eval2_->operator[](v)); }
  RVAL operator[](const EdgeIdType &e) override { return this->func_(this->eval1_->operator[](e), this->eval2_->operator[](e)); }
  RVAL operator[](const VertexIdType &v) override { return this->func_(this->eval1_->operator[](v), this->eval2_->operator[](v)); }

  /** \brief Const accessor methods. */
  RVAL at(const SimpleEdge &e) const override { return this->func_(this->eval1_->at(e), this->eval2_->at(e)); }
  RVAL at(const SimpleVertex &v) const override { return this->func_(this->eval1_->at(v), this->eval2_->at(v)); }
  RVAL at(const EdgeIdType &e) const override { return this->func_(this->eval1_->at(e), this->eval2_->at(e)); }
  RVAL at(const VertexIdType &v) const override { return this->func_(this->eval1_->at(v), this->eval2_->at(v)); }
  // clang-format on
...
class UnaryOp : public EvalBase<RVAL> {
 public:
  ...
  void setGraph(void *graph) override { eval_->setGraph(graph); }
  ...
  // clang-format off
  /** \brief Non-const accessor methods. \note doesn't return a reference */
  RVAL operator[](const SimpleEdge &e) override { return this->func_(this->eval_->operator[](e)); }
  RVAL operator[](const SimpleVertex &v) override { return this->func_(this->eval_->operator[](v)); }
  RVAL operator[](const EdgeIdType &e) override { return this->func_(this->eval_->operator[](e)); }
  RVAL operator[](const VertexIdType &v) override { return this->func_(this->eval_->operator[](v)); }

  /** \brief Const accessor methods. */
  RVAL at(const SimpleEdge &e) const override { return this->func_(this->eval_->at(e)); }
  RVAL at(const SimpleVertex &v) const override { return this->func_(this->eval_->at(v)); }
  RVAL at(const EdgeIdType &e) const override { return this->func_(this->eval_->at(e)); }
  RVAL at(const VertexIdType &v) const override { return this->func_(this->eval_->at(v)); }
  // clang-format on
