...
/**
 * \file radar_pc_extraction_module.cpp
 * \author Sam Qiao, Autonomous Space Robotics Lab (ASRL)
 * \brief base_radar_extraction_module class methods definition
**/
 
#include "vtr_radar/modules/preprocessing/conversions/pc_extraction_module.hpp"
...
// this is a base extraction module for radar data

auto BaseRadarPCExtractionModule::Config::fromROS(
...
void BaseRadarPCExtractionModule::run_(QueryCache &qdata0, OutputCache &,
                                   const Graph::Ptr &,
