...
#include <vtr_tactic/task_queues/fifo_task_queue.hpp>
...
class BasePipeline {
 public:
   ...
   */
  virtual void setTaskQueue(const FIFOTaskQueue::Ptr &tq) { task_queue_ = tq; }
 ...
 protected:
  ...
  FIFOTaskQueue::Ptr task_queue_ = nullptr;
