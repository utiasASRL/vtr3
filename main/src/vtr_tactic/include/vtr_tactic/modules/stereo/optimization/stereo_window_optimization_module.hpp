...
class StereoWindowOptimizationModule : public SteamModule {
 ...
 protected:
  ...
  virtual void updateCaches(QueryCache &qdata);
 ...
 private:
   ...
   * latest vertex.
   */
  void saveTrajectory(QueryCache &qdata,
   ...
   */
  virtual bool verifyInputData(QueryCache &qdata);

  /**
   * \brief Verifies the output data generated byt the optimization problem
   * \param qdata The query data.
   */
  virtual bool verifyOutputData(QueryCache &qdata);
