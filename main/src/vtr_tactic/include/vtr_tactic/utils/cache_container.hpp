...
class cache_base {
 ...
 protected:
  ...
  virtual ~cache_base() noexcept(false) {
...
//   /// @param[in] janitor required for cleanup and container member
//   registration template <typename... Args> cache_future(cache_janitor
//   *janitor) : parent_t(janitor) {
//   }
