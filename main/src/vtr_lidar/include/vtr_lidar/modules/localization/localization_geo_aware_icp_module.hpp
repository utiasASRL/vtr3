...
/**
 * \file localization_geo_aware_icp_module.hpp
 */
#pragma once
...
class LocalizationGEOModule : public tactic::BaseModule {
 public:
  /** \brief Static module identifier. */
  static constexpr auto static_name = "lidar.localization_geo_aware_icp";
 ...
 private:
  ...
  VTR_REGISTER_MODULE_DEC_TYPE(LocalizationGEOModule);
};
