...
/**
 * \file odometry_doppler_bias_module.hpp
...
class OdometryDopplerBiasModule : public tactic::BaseModule {
 public:
  using PointCloudMsg = sensor_msgs::msg::PointCloud2;

  /** \brief Static module identifier. */
  static constexpr auto static_name = "lidar.odometry_doppler_bias";
 ...
 protected: 
  ...
  VTR_REGISTER_MODULE_DEC_TYPE(OdometryDopplerBiasModule);
};
