 ...
 */
  ...
  * LiDAR.
  */
 class RSConversionModule : public tactic::BaseModule {
  public:
   using PointCloudMsg = sensor_msgs::msg::PointCloud2;
 
   /** \brief Static module identifier. */
   static constexpr auto static_name = "lidar.rs_converter";
  ...
  private:
   ...
   VTR_REGISTER_MODULE_DEC_TYPE(RSConversionModule);
 };
