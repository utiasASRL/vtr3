...
ros2 run vtr_testing_boreas vtr_testing_boreas_odometry_direct  --ros-args  -r __ns:=/vtr  --params-file ${VTBCONFIG}/boreas.yaml  -p data_dir:=${VTBRESULT}/boreas  -p odo_dir:=${VTBDATA}/boreas-2020-12-01-13-26

## Perform localization on a sequence directly
ros2 run vtr_testing_boreas vtr_testing_boreas_localization_direct  --ros-args  -r __ns:=/vtr  --params-file ${VTBCONFIG}/boreas.yaml  -p data_dir:=${VTBRESULT}/boreas  -p loc_dir:=${VTBDATA}/boreas-2021-03-02-13-38  -p odo_dir:=${VTBDATA}/boreas-2020-12-01-13-26
