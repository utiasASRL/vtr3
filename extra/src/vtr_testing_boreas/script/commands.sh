...
export VTBRESULT=${VTRTEMP}/testing/lidar/boreas.odometry
...
ros2 run vtr_testing_boreas vtr_testing_boreas_localization_direct  --ros-args  -r __ns:=/vtr  --params-file ${VTBCONFIG}/boreas.yaml  -p data_dir:=${VTBRESULT}/boreas  -p input_dir:=${VTBDATA}/boreas-2020-12-01-13-26
